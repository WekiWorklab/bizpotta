...
function Banner({ setOpen }, {setClose}) {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl py-3 lg:py-1 px-3 sm:px-6 lg:px-4">
          <div className="flex flex-wrap items-center justify-between">
            <div className="flex flex-col lg:flex-row w-full flex-1 items-center">
              <p className="ml-3 lg:pr-16 flex-nowrap text-ellipsis overflow-hidden font-medium text-white text-sm lg:text-sm lg:w-full">
                <span className="md:hidden">
                Bizpotta MasterClass: ACHIEVING EXPONENTIAL GROWTH AND BUSINESS SUSTAINABILITY
                </span>
              ...
              <div className="lg:-ml-14 w-full flex items-center mt-0 justify-center lg:justify-start">
                <Link href={"/masterclassevent"} passHref>
                  <a
                    href="#"
