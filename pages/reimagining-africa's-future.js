    ...
    return(
        <div className="w-full flex flex-row ">
            <div className="w-full md:w-[60%] xl:w-[40%] h-full md:h-screen px-2 sm:px-4 xl:px-10 flex flex-col py-3">
                ...
                <div className=" block md:hidden bg-no-repeat bg-contain bg-center w-full h-[200px] mt-4" style={{backgroundImage: "url(./images/EventMobile.webp)"}} />
            ...
            <div className="bg-no-repeat bg-cover bg-center w-[40%] xl:w-[60%] hidden md:block md:h-screen" style={{backgroundImage: "url(./images/EventImage.webp)"}} />
...
const FormInput = ({title, name, type, setData}) => {
    ...
    return (
        <div className="">
            ...
            <input type = {type} name={name} required className="w-full h-[40px] rounded-md focus:ring-0 focus:outline-none outline-none border border-[1px] mt-1" onChange={handleChange} />
        </div>
    )
}