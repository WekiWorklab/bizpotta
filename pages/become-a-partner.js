...
export default function BecomeAPartner() {
  ...
  return (
    <>
      <Head>
        <title key='title'>BizPotta - Become A Partner</title>
      </Head>
...
const InterestList = () => {
  const interests = [
    "Individuals or organizations interested in contributing to the growth and support of MSMEs across Nigeria and Africa.",
    "Training institutions, business consultants, or entities offering relevant services for entrepreneurs.",
    "Financial institutions or investors seeking to connect with potential business opportunities.",
    "Tech companies or solution providers offering tools and resources for business development",
  ];
