...
import { MdOutlineDashboard, MdOutlineLiveTv } from "react-icons/md";
        ...
        <div className='w-full mt-20'>
          <ul className='md:flex-col md:min-w-full flex flex-col list-none mb-20 mt-5 '>
              ...
              <div className='flex flex-row justify-start items-center'>
                <HiOutlineBookOpen
                  color={
                    ...
                    path === "/students/courses/masterclass"
                      ? "#121F4C"
                      : "gray"
                  }
                />
            ...
            <li
              ...
              <div
                ...
                <MdOutlineLiveTv />
                <div className={`text-sm ml-5`}>Live Session</div>
              </div>
            </li>
          </ul>
          ...
          <ul className='md:flex-col md:min-w-full flex flex-col list-none mb-10 mt-5 '>
            <li
              className={`${
                path === "/students/profile"
                  ? "text-darkBlue font-semibold"
                  : "text-gray-400 font-light"
              } items-center cursor-pointer mb-5`}
              onClick={() => router.push("/students/profile")}>
              <div className='flex flex-row justify-start items-center'>
                <CgProfile />
                <div className='text-sm  ml-5'>Profile</div>
              </div>
            </li>
            ...
            <li
              ...
              <div className='flex flex-row justify-start items-center'>
                <IoSettingsOutline />
                <div className='text-sm  ml-5'>Settings</div>
              </div>
            </li>
