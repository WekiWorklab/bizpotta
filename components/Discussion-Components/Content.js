        ...
        <div className="w-full lg:w-[700px]  lg:px-10">
          ...
          <div className="border-2 border-gray-400 rounded-md mt-6 px-2 sm:px-6 pb-4 ">
            <div className="flex flex-row justify-between items-center h-10 w-full mt-2 sm:mt-6 ">
              ...
              <AiOutlineDown
                onClick={handleClick}
                className={drop ? "arrow-right" : "arrow-down"}
              />
            </div>
            <div
...
const Message = ({ name }) => {
  ...
  return (
    <div className="w-full border-2  border-gray-400 rounded-md px-2 sm:px-4 py-4 mt-4 sm:mt-8 text-[12px] sm:text-[14px]">
      <div>
        Hi welcome to the forum, kindly go ahead and introduce yourself, feel
        free to ask relevant questions, intereact with your course mate, share
        knowledge and idea. We are here for one another.{" "}
      </div>
      <div className="flex flex-row justify-between items-center mt-4">
        <div className="flex flex-row justify-between gap-x-2 sm:gap-x-4">
          <div className="w-[70px] h-[27px] sm:w-[90px] sm:h-[35px] rounded-md border flex justify-center items-center">
            Like
          </div>
          <div className="w-[70px] h-[27px] sm:w-[90px] sm:h-[35px] rounded-md border flex justify-center items-center">
            Dislike
...
const DiscussionPanel = () => {
  ...
  return (
    <div className="w-full flex flex-row justify-between items-center mt-3">
      <div
        className={`text-[14px]  flex flex-row items-center w-[250px] text-[18px] font-[600] ${
          paginate === 1 ? "border-b-2" : ""
        } border-darkBlue h-[40px]  justify-center`}
