...
import { showCourseDetailsModal, showMasterclassModal } from '../store/courseSlice';
import { offer, specialization } from '../public';
import { HiUserGroup } from 'react-icons/hi';


const MasterclassDetailsModal = () => {

    const dispatch = useDispatch()
    const success = useSelector(state => state.course.show_masterclass_modal)
    console.log(success)

  const closeModal = () => {
        dispatch(showMasterclassModal(false))
  } 
          ...
          >
            <div className=" relative inline-block align-top mt-24 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all">
              ...
              <div className='w-full sm:w-[500px] pb-8 overflow-y-scroll styled-scrollbar  h-[500px] bg-white'>
                <div className='w-full h-[200px] sm:h-[250px] pb-6 bg-center bg-cover bg-no-repeat flex flex-col justify-end items-center ' style={{backgroundImage: `url(${specialization.src})`}}>
                    <p className='text-white font-bold text-[20px]'>Increase Sales in 30 days</p>
                    <p className='text-white font-bold mt-0'>Charles Mark</p>
                    <div className='w-[120px] h-[30px] mt-4 centerFlex text-[13px] bg-bizpotta-green rounded-lg'>Purchase course</div>
                </div>
                ...
                <div className='w-full px-5 mt-3 '>
                  ...
                  <div className='grid grid-cols-1 sm:grid-cols-2 w-full mt-4 justify-start gap-x-4 items-center'>
                    <div className='flex flex-col gap-y-2'>
                        <div className='flex items-center gap-x-3'>
                          ...
                          <p className='text-darkText text-[12px]'>by Thomas Mat (Ph.d, Ms.c)</p>
                        </div>
                        <div className='flex items-center gap-x-3'>
                          <img src={specialization.src} className='w-[30px] h-[30px] rounded-full' />
                    ...
                    <div className='flex flex-col gap-y-2 mt-2 sm:mt-0'>
                        ...
                        <div className='flex items-center'>
                          ...
                          <p className='text-darkText text-[12px]'>1,321 enrolled</p>
                        </div>
                    </div>
                  </div>
                  ...
                  <div className='grid  sm:grid-cols-2 w-full items-start'>
                    <div className='flex flex-col '>
                        ...
                        <div className='flex items-center gap-x-3'>
                          <p className='text-darkText text-[12px] font-bold'>Caption:</p>
                          <p className='text-darkText text-[12px]'>English</p>
                        </div>
                    </div>
                    <div className='flex flex-col '>
                  ...
                  <p className='text-darkText text-[12px]'>   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Orci blandit id mollis metus porttitor ut aliquam. Aliquam fermentum felis viverra egestas justo, lacinia ac. Nibh etiam morbi egestas sed id iaculis. Eu eget ac felis ac. Quisque phasellus sit et eget ut quis pellentesque. Quam sed bibendum integer odio lacus elit sit scelerisque. Nunc volutpat vel dictum neque. Commodo euismod vulputate congue urna adipiscing bibendum. Sit nulla sed velit tellus rhoncus elementum ac elementum, malesuada. Vivamus faucibus sed augue massa habitasse neque. Aliquam, curabitur pulvinar auctor turpis a. Placerat sed tortor, quisque a, tel sed egestas sodales. Habitant quam sagittis elit habitant dui.</p>
                  ...
                  { lessonOutline.map((el, index) => (
                      ...
                      <div className=''>{index + 1 < 10 ? `0${index + 1}` : index + 1}.</div>
                      <p className = ''>{el}</p>
                      </div>
                  ...
                  <p className='text-[14px] font-bold text-darkBlue  text-left mt-4'>About Leo’s Photography</p>
                  <p className='text-darkText text-[12px]'>   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Orci blandit id mollis metus porttitor ut aliquam. Aliquam fermentum felis viverra egestas justo, lacinia ac. Nibh etiam morbi egestas sed id iaculis. Eu eget ac felis ac. Quisque phasellus sit et eget ut quis pellentesque. Quam sed bibendum integer odio lacus elit sit scelerisque. Nunc volutpat vel dictum neque. Commodo euismod vulputate congue urna adipiscing bibendum. Sit nulla sed velit tellus rhoncus elementum ac elementum, malesuada. Vivamus faucibus sed augue massa habitasse neque. Aliquam, curabitur pulvinar auctor turpis a. Placerat sed tortor, quisque a, tel sed egestas sodales. Habitant quam sagittis elit habitant dui.</p>

                  <p className='text-[14px] font-bold text-darkBlue  text-left mt-4'>About Instructors</p>
                  <p className='text-darkText text-[12px]'>   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Orci blandit id mollis metus porttitor ut aliquam. Aliquam fermentum felis viverra egestas justo, lacinia ac. Nibh etiam morbi egestas sed id iaculis. Eu eget ac felis ac. Quisque phasellus sit et eget ut quis pellentesque. Quam sed bibendum integer odio lacus elit sit scelerisque. Nunc volutpat vel dictum neque. Commodo euismod vulputate congue urna adipiscing bibendum. Sit nulla sed velit tellus rhoncus elementum ac elementum, malesuada. Vivamus faucibus sed augue massa habitasse neque. Aliquam, curabitur pulvinar auctor turpis a. Placerat sed tortor, quisque a, tel sed egestas sodales. Habitant quam sagittis elit habitant dui.</p>
