    ...
    <footer className='bg-bizpotta-green' aria-labelledby='footerHeading'>
      ...
      <div className='max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8'>
        <div className='w-full flex flex-col items-center justify-center md:flex-row flex-wrap md:justify-between gap-6 md:gap-0'>
          <div>
            <h3 className='text-center text-sm font-semibold text-gray-900 tracking-wider uppercase'>Solutions</h3>
      ...
      <div className='mt-12 bg-gray-900 border-t border-gray-200 py-8 flex justify-between px-10 pt-8 md:flex md:items-center md:justify-between'>
