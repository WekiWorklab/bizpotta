...
const ClassCards = () => {
  ...
  return (
    <div className='hidden md:grid md:grid-cols-2 lg:grid-cols-3 flex-row items-center flex-wrap w-full xl:w-[80%] justify-between pl-0 mt-4'>
        <div className={`w-[260px] ${pathName === '/students/courses/vocational' ? "bg-[#5FFC54]" : "bg-[#2ABB1A]"}  h-[125px] rounded-lg flex items-center text-sm pl-5 mb-8 cursor-pointer`} onClick = {() => router.push('/students/courses/vocational')}>
        ...
        <div className='w-full md:col-span-2 lg:col-span-1 flex justify-center lg:justify-start'>
            <div className={`w-[260px] ${pathName === '/students/courses/masterclass' ? "bg-[#5FFC54]" : "bg-[#2ABB1A]"}  h-[125px] rounded-lg flex items-center text-sm pl-5 mb-8 cursor-pointer`} onClick = {() => router.push('/students/courses/masterclass')}>MASTER CLASS</div>
        </div>
    </div>
  )
}
  ...
  useEffect(() => {
    ...
    return(
        ...
        >
            ...
            <SwiperSlide style={{backgroundColor: "transparent"}}>
            <div className={`w-[260px] ${pathName === '/students/courses/masterclass' ? "bg-[#5FFC54]" : "bg-[#2ABB1A]"}  h-[125px] rounded-lg flex items-center text-sm pl-5 mb-10 cursor-pointer`} onClick = {() => router.push('/students/courses/masterclass')}>MASTER CLASS</div>
            </SwiperSlide>
        </Swiper>
    )
}
