  ...
  return (
    <div className='relative w-full h-full bg-white sm:bg-gray-50 flex flex-col pt-[90px] md:pt-[120px] md:justify-center items-center md:translate-x-[200px] md:w-[calc(100%-200px)] px-2 md:px-10 pb-10 text-darkGray'>
        <div className='w-full mt-10'>
            ...
            <div className='w-full min-h-[100px] rounded-[4px] mt-6 px-6 py-6 bg-white '>
                ...
                <div className='flex flex-row mt-10 justify-between '>
                    <div className='flex flex-col gap-y-6'>
                        <div className=' text-[14px] flex flex-row items-center gap-x-4'>
                            <p>Introduction to Human Management</p>
                    ...
                    <div className='w-full md:w-[600px] text-[14px]'>
