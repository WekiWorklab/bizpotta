...
const image = 'https://cdn.pixabay.com/photo/2022/01/17/17/20/bored-6945309__340.png'
  ...
  return (
    <div className='redBorder w-full pt-4 pr-24 '>
        <div className='text-[13px]'>
            <AiOutlineLeft className='inline mr-2'/>
            <p className='inline'>Go to home</p>
        </div>

        <div className='w-[850px] h-[370px] mt-4'>
            <ReactPlayer
        ...
        <div className='flex flex-row items-center w-full justify-between redBorder'>
            <div className='flex flex-row items-center '>
                <img src={image} className='w-[40px] h-[40px] rounded-full mr-4 '/>
                <p>by Thomas Mat (Ph.d, Ms.c) </p>
            </div>
            <div className='flex flex-row justify-self-end redBorder items-center'>
        ...
        <div className=' grid grid-cols-3 text-[13px] redBorder'>
