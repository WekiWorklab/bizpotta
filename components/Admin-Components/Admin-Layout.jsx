...
const MobileAdminSideBar = ({show, setShow, slideIn, setSlideIn}) => {
    ...
    return (
        <div className={`${slideIn ? "SideBar" : "NoSideBar" } fixed block md:hidden left-0 top-0 z-30 w-[300px] h-screen rounded-r-xl dropdown-shadow bg-white py-5`}>
            ...
            <div className='flex flex-col gap-y-3 mt-4'>
                {
                    SidebarNav.map((el, index) => (
                        <Link href={el.to} key={index} >
                            <div className='h-[50px] flex items-center gap-x-6 cursor-pointer hover:bg-gray-300'>
...
const AdminSideBar = () => {
    ...
    return (
        <div className='fixed hidden md:block bg-white left-0 top-0 z-30 w-[250px] h-screen border border-r-2  py-5'>
