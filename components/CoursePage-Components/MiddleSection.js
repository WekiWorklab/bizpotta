  ...
  return (
    ...
    <div className='bg-transparent w-full xl:w-full lg:mx-auto lg:mx-0'>
      <div className='pt-[50px] flex flex-col'>
        <p className='text-[14px] text-start  lg:pl-4  mb-4 md:text-md font-semibold md:font-bold md:mb-8  '>
          Browse course based on your recent activities
        </p>
        <div className='bg-gray-200 pt-10 rounded-sm'>
      ...
      <div className='pt-[50px] flex flex-col'>
        <p className='text-[14px] text-center lg:text-left lg:pl-4  mb-4 md:text-md font-semibold md:font-bold md:mb-8  '>
          Based on your recent activites
        </p>
        <div className='block w-[360px] m-auto md:hidden w-full'>
          <ContentCarousel data={Data} screen={[1.5, 10]} type='vocational' />
        </div>
