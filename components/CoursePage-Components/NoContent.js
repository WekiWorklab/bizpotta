...
const NoContent = () => {
  ...
  return (
    ...
    {/* onClick = {() => router.push('/students/masterclass')} */}
...
{/* <div className='hidden md:flex flex-row items-center flex-wrap  md:w-[90%] lg:w-[70%] xl:w-[80%] justify-between pl-0 mt-4'>
        ...
        <div className='w-[260px] bg-[#2ABB1A] h-[125px] rounded-lg flex items-center text-sm pl-5 mb-10' onClick = {() => router.push('/students/masterclass')}>MASTER CLASS</div>
    </div> */}
