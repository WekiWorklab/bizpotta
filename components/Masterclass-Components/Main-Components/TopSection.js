...
import { CurvyUnderline, DownCurvyArrow, LeftEllipse, offer, RightEllipse, UpCurvyArrow } from '../../../public';
    ...
    <div className='w-full rad-gradient pb-10'>
        ...
        <div className='px-24'>
            ...
            <div className='w-full px-[190px] flex flex-col items-center justify-center gap-y-6 '>
                ...
                <p className='text-xl text-center '>Learn, grow, and connect with established entrepreneurs with results to show in their business journey</p>
