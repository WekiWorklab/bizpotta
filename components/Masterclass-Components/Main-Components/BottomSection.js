  ...
  return (
    <div className='w-full  bg-gradient-to-b from-[#FDFFFA] to-[#FDFFFA] pb-20 pt-10'>
        ...
        <div className='px-3 sm:px-10 xl:px-20 mt-20 xl:mt-32'>
            <div className='text-center sm:text-left text-xl font-bold'>Learn social tools for business success</div>              
        ...
        <div className='px-3 sm:px-10 xl:px-20 mt-20 xl:mt-32'>
            <div className='text-center sm:text-left text-xl font-bold'>Get to Meet Top Business Expert</div>              
        ...
        <div className='px-3 sm:px-10 xl:px-20 mt-20 xl:mt-32'>
            <div className='text-center sm:text-left text-xl font-bold'>What our learners have to say</div>              
            {/* <div className='w-full'>  
            <TestimonialCarousel />
            </div> */}
            <div className="block mx-auto md:hidden w-full">
                <TestimonialCarousel screen={[1.2, 5]} />
            </div>
            <div className="hidden  md:block lg:hidden w-full">
    ...
    return(
      <div className='w-full pb-4 border-b-2 border-gray-700 mt-4 '>
        ...
        <div className=' overflow-y-hidden parent-drop' style={{height: `${height}px` }} ref={parentRef}>
          <div className={`${(show ? "show-drop": "no-drop")} text-[14px] md:text-base`} ref={childRef}>
