...
const MiddleSection = () => {
  return (
    <div className='w-full  bg-gradient-to-b from-[#E5E5E5] to-[#E5E5E5] px-20 py-16'>
        <p className='text-xl font-bold'>Expand your skillset, gain insights, and get support from mentors</p>
        <div className='w-full h-[500px] mt-10 bg-center bg-no-repeat bg-cover' style={{backgroundImage: `url(${offer.src})`}} />
        ...
        <div className='px-10 mt-28'>
            ...
            <div className='w-full flex items-center justify-center gap-x-16 mt-10'>
                <div className='w-[300px] h-[180px] text-white bg-darkBlue rounded-md py-4 px-6 flex flex-col justify-between'>
                    <p>Career advice</p>
                    <p className='text-sm w-[90%]'>Navigate career transitions, promotions and access a sounding board for career decisions.</p>
                ...
                <div className='w-[300px] h-[180px] text-white bg-darkBlue rounded-md py-4 px-6 flex flex-col justify-between'>
                    ...
                    <p className='text-sm w-[90%]'>Develop specific skills you want to improve in order to succeed in your career..</p>
                    <div className='w-[100px] h-[30px] centerFlex border rounded-md text-xs'>
                        Get started
                    </div>
                </div>
        ...
        <div className='w-full flex items-center gap-x-10 mt-10'>
            ...
            <div className='w-1/3 h-full'>
                ...
                <div className='gap-y-3 flex flex-col'>
                    ...
                    <div className='bg-white rounded-md p-2 flex flex-col justify-center'>
                        <p className='text-[13px] w-2/3'>Getting Started With Figma; A Designer’s First Step.........</p>
