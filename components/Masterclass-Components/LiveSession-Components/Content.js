    ...
    return(
        ...
        <div className='flex items-center border masters-shadow2 border-[#b1adad] rounded-md px-3 sm:px-6 py-4 sm:py-8 w-full mt-16'>
                <div className='w-full sm:w-2/3'>
                    ...
                    <div className='mt-4 flex items-center text-xs gap-x-2'>
                        <div className='w-[40px] h-[40px] rounded-full bg-no-repeat bg-cover bg-center' style={{backgroundImage: `url(${specialization.src})`}} />
                        <p>723+ attending</p>
                    </div>
                ...
                <div className='hidden sm:flex flex-col justify-center items-center  w-1/3'>
                    <div className='w-full h-[200px] bg-no-repeat bg-cover bg-center ' style={{backgroundImage: `url(${specialization.src})`}}>
