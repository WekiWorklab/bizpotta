...
const CourseLanding = ({ data, setSelect }) => {
  ...
  const { message, isError, isSuccess, courseID } = useSelector(
    (state) => state.creator
  );
      ...
      <div className='px-4 md:px-10 bg-white py-8 mt-10 rounded-sm shadow-xl border'>
        ...
        <form onSubmit={handleSubmit(submitCourse)}>
          <div className='text-[13px] mt-6'>
            ...
            <span className='text-seaBlue'>Landing Page</span> and will have a
            direct impact on your course performance. These descriptions will
            help learners decide if your course is right for them.
          </div>

          <div className=' mt-10'>
            <p className='text-[13px] font-bold'>Course Title</p>
            <p className='text-[12px]'>
              Give your course a clear title that will explain what the course
              is all about. Max of 100 words.
            </p>
          ...
          <div className=' mt-10'>
            ...
            <p className='text-[12px] mt-2 '>
              Kindly give a detailed decription of your course. Minimum 1000
              words
            </p>
            <textarea
              {...register("courseDescription")}
              className='w-full lg:w-[600px] min-h-[200px] bg-[#FCFDFE] focus:ring-0 focus:outline-none border rounded-md text-[#000] pl-4 text-[14px] mt-2'></textarea>
            <div className='px-4 text-red-500 text-[12px] md:text-sm font-medium'>
          ...
          <div className=' mt-10'>
            ...
            <p className='text-[12px]'>
              Image quality 750x422 pixel. jpg, jpeg, gif or png
            </p>

            <div className='h-[40px] w-full sm:w-[300px] lg:w-[500px] bg-[#FCFDFE] focus:ring-0 focus:outline-none border rounded-md text-[#000] pl-4 text-[15px] flex flex-row items-center gap-x-4'>
