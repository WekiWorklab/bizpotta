    ...
    <div className='w-full'>
      ...
      <div className='w-full border-[1px] rounded-sm border-gray-500 mt-8 py-10 pl-10 px-4'>
        ...
        <div className='text-[13px]'>
          You can create minimum of <span className='text-seaBlue'>two section for short class</span> and maximum of{" "}
          <span className='text-seaBlue'>four sections for full class</span>. I advise you read the article on{" "}
          <span className='text-seaBlue'>getting started in teaching</span>
        </div>
  ...
  return (
    <div className='w-[550px]'>
      <div className='flex w-full justify-between items-center'>
        <div>
          Section 1 <span className='text-gray-400 text-[14px]'>Week 1</span>
        </div>
