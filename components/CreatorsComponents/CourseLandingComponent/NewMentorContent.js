            ...
            <div className='px-10 bg-white py-8 mt-10 rounded-md shadow-xl w-[700px]'>
                ...
                <div className='flex flex-row items-center gap-x-6 mt-10'>
                    <div className='flex items-center px-4 py-4 border rounded-lg shadow-md' >
                        ...
                        <label htmlFor='file' className='w-[100px] h-[30px] bg-darkBlue text-white flex flex-row justify-center items-center rounded-md gap-x-4 ml-6'>
                            <p className='text-[12px]'>Browse</p>
                            <AiFillCaretDown color='white'/>
                            <input type='file' id='file' accept='.jpg, .png, .jpeg' className='hidden' />
                        </label>
                    </div>
                </div>
                ...
                <div className=' mt-10'>
                    <p className='text-[13px] font-bold'>Your Company Profile</p>
                    <textarea className='w-[600px] min-h-[200px] bg-[#FCFDFE] focus:ring-0 focus:outline-none border rounded-md text-[#C4C4C4] pl-4 text-[14px]'>
                ...
                <div className='flex flex-col items-start gap-y-3 mt-12'>
                    <div className='flex items-center pl-4 border rounded-lg shadow-md' >
                        <p className='text-[12px] mr-2'>Upload a Logo thumbnail for easy identification</p>
                        <label htmlFor='file' className='w-[50px] h-[40px] centerFlex bg-[#F5F9FF]'>
                            <AiOutlinePicture className='w-[30px] h-[30px]'/>
                            <input type='file' id='file' accept='.jpg, .png, .jpeg' className='hidden' />
                        </label>
                        
                    </div>
                    <p className='text-[11px] text-[#999999]'>This is the first image attendees will see at the top of your listing. Use a high quality image: 48x48px (1:1 ratio)
                        </p>
                </div>


                <div className=' mt-10'>
                    <p className='text-[13px] font-bold'>Job location status</p>
                    <div className='flex items-center gap-x-8 mt-2'>
                        <div className='flex items-center gap-x-1'>
                            <div className='centerFlex w-[16px] h-[16px] border border-darkBlue rounded-full' onClick={() => setJobLocation('physical')}>
                                { jobLocation === 'physical' && <div className='w-[10px] h-[10px] rounded-full bg-darkBlue' />}
                            </div>
                            <p className='text-[13px] '>Physical</p>
                        </div>

                        <div className='flex items-center gap-x-1'>
                            <div className='centerFlex w-[16px] h-[16px] border border-darkBlue rounded-full' onClick={() => setJobLocation('remote')}>
                                { jobLocation === 'remote' && <div className='w-[10px] h-[10px] rounded-full bg-darkBlue' />}
                            </div>
                            <p className='text-[13px] '>Remote</p>
                        </div>

                        <div className='flex items-center gap-x-1'>
                            <div className='centerFlex w-[16px] h-[16px] border border-darkBlue rounded-full' onClick={() => setJobLocation('hybrid')}>
                            { jobLocation === 'hybrid' && <div className='w-[10px] h-[10px] rounded-full bg-darkBlue' />}
                            </div>
                            <p className='text-[13px] '>Hybrid</p>
                        </div>
                ...
                <div className=' mt-10'>
                    <p className='text-[13px] font-bold'>Job location</p>
                    <p className='text-[11px]'>Provide a detailed description of where your office is located</p>
                    <div className='flex flex-row  mt-2'>
                        <InputForm width='500px' placeholder='' type='text'/>
                    </div>
                </div>
...
{/* #121F4C */}
            ...
            <div className=' w-[260px] flex flex-col items-center mt-32 gap-y-8'>
                ...
                <div className='w-full h-[47px] flex flex-row justify-center items-center rounded-xl gap-x-10 text-white bg-gray-200'>
                    <BsCameraVideo size={24}  color = 'black'/>
                    <p className='text-black'>Request live video</p>
                </div>
...
export default NewMentorContent