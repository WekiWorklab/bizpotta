...
const VideoCard = () => {
    ...
    return(
        <div className='lg:w-[360px] lg:h-[270px] w-[280px] h-[230px] rounded-md bg-no-repeat bg-cover bg-center flex flex-col items-center justify-end shadow-xl' style={{backgroundImage: `url(${image})`}}>
            <BsPlayCircle size={30} color="white"/>
            <div className='w-full bg-darkBlue mt-6 text-white text-[13px] px-6 pt-2 lg:pt-4 pb-2'>
