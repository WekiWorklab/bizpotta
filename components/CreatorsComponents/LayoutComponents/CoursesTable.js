              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {data.map((el) => (
                  <tr key={el.item}>
                    ...
                    <td className="px-2 py-4 whitespace-nowrap text-center">
                      <div className={`text-sm text-gray-900 text-[12px] text-center p-1 rounded-sm ${el.status ? "bg-[#2DE200] bg-opacity-[0.15] text-[#26B403]" : "bg-[#FC4A4A] bg-opacity-[0.15] text-[#B40303]"} `}>{el.status ? "Active" : "Inactive"}</div>
                    </td>
                    <td className="px-2 py-4 whitespace-nowrap text-center">
