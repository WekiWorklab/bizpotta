      ...
      <div className='w-full px-0 sm:px-4 py-4 sm:border mt-7 rounded-md'>
        ...
        <div className='mt-14  text-[14px] font-bold'>
          ...
          <div className='w-full mt-5'>
            <input type='text' className='w-full md:w-[80%] h-[40px] border border-[#E5E5E5] rounded-md px-4' />
          </div>
        </div>
        ...
        <div className='mt-14 flex flex-col sm:flex-row  sm:items-center gap-y-5 gap-x-7'>
          <div>
            ...
            <input type='date' className='inputField w-[300px] text-[14px] mt-2 sm:mt-4' placeholder={Date.now()} />
          </div>

          <div>
            <p className='text-[14px] font-bold'>Time </p>
            <input type='time' className='inputField w-[200px] text-[14px] mt-4' />
          </div>
        </div>

        <div className='mt-14'>
          <p className='text-[14px] font-bold'>Choose course category</p>
          <SelectOptions option={course} setOption={setCourse} open={open} setOpen={setOpen} width='320px' data={data1} type='0' />
        </div>

        <div className='mt-14'>
          <p className='text-[14px] font-bold'>Choose price range</p>
          <SelectOptions option={price} setOption={setPrice} open={open} setOpen={setOpen} width='320px' data={data2} type='1' />
        </div>
        ...
        <div className=''>
          <button className='text-white text-[13px] bg-darkBlue px-4 py-2 rounded-md mt-8 justify-self-end'>Save changes</button>
        </div>
      </div>
    </div>
  );
