  ...
  return (
    <div className="relative w-full h-full bg-[#FEFEFE] flex flex-col mt-[90px] md:mt-[120px] md:justify-center items-start md:translate-x-[250px] md:w-[calc(100%-250px)] px-2 xl:px-8 py-6  text-darkGray ">
        ...
        <div className='w-full flex justify-between items-center'>
            ...
            <button className='flex items-center px-3 py-3 gap-x-2 text-[13px] rounded-md dashboard-card-shadow bg-white' onClick={() => router.push('/creators/live-session/new')}>
            ...
            <div className='w-full flex flex-col-reverse xl:flex-row items-center xl:items-start xl:justify-between mt-8 '>
                <div className='w-full sm:w-[500px] mt-10 xl:mt-0'>
                    <div className='w-full bg-white rounded-xl'>
                        <div className='w-full h-[400px] px-3 rounded-xl flex flex-col justify-end  bg-center bg-cover bg-no-repeat' style={{backgroundImage: `url(${specialization.src})`}}>
                    ...
                    <div className='text-[#B3B3B3] text-[13px] mt-2'>Hosted by <span className = 'text-[#5CAC0D]'>  Mark Andrews </span> </div>
                    ...
                    <p className='mt-4 text-[#444444] text-[13px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Egestas cursus sit enim facilisi gravida ligula bibendum dignissim penatibus. Justo dapibus in venenatis, nunc. Vulputate leo ultrices id bibendum. Volutpat duis amet curabitur vestibulum morbi facilisis. Nulla mauris tellus eu nibh nulla quam et arcu.
Tellus non, ullamcorper convallis fermentum libero commodo. Pellentesque vulputate aliquet etiam blandit sagittis nec aliquet pellentesque tellus. Id posuere bibendum id sed ut tellus. Elementum massa sed arcu pellentesque tempor. Arcu massa sed ultrices quis justo, lorem consectetur. Tincidunt nulla est, non imperdiet posuere erat. Enim, aliquet sed lectus id. Nisl ut proin nulla at sagittis egestas accumsan elit nunc. Cras lacus, justo eget vulputate. Et potenti enim, posuere eget nunc sagittis sodales id. Ut tortor et nulla sit convallis habitasse consectetur lorem in. Mi augue ipsum tristique quis est nec sodales vitae. Vitae porta amet odio sed dictum. Semper eget leo, feugiat orci diam. Habitant netus malesuada urna, feugiat amet consectetur cursus sem.
In dictum sit tempor, diam fames lorem. Egestas enim consequat leo quam. Viverra lorem proin viverra cras sollicitudin in imperdiet suspendisse ac. Eu gravida nunc pretium porttitor. Sed placerat est sed nunc tellus dis. Eget orci gravida curabitur cursus massa at sed id scelerisque. Egestas sed sapien nisl nunc eros faucibus purus amet, felis.
Quis at amet vel, euismod. Et viverra vestibulum egestas ornare cursus amet purus in. Ullamcorper urna, sollicitudin fringilla nulla orci, maecenas fringilla urna. Magna ut porta ac cras sed diam diam volutpat. Leo ipsum lacus, metus a cras morbi commodo quam. Mattis cras interdum nisl, mattis lacus tortor amet. Augue vitae, et quis lobortis morbi id dictum sed. Ipsum felis habitasse morbi duis auctor. Rhoncus neque non orci.</p>
        ...
        {/* If there is no scheduled live-session */}

            {
               ...
               <div className=' min-h-[calc(100vh-180px)] sm:min-h-[calc(100vh-150px)] w-full flex flex-col justify-center gap-y-4 sm:gap-y-12 items-center'>
                        ...
                        <div className = 'w-[140px] h-[40px] centerFlex bg-darkBlue rounded-md text-[14px] cursor-pointer text-white' onClick={() => router.push('/creators/live-session/new')}> 
                            Create live session
                        </div>
               </div>
            }
