...
const Content = () => {
  return (
    <div className='relative w-full h-full bg-white  flex flex-col mt-[90px] md:mt-[120px]  md:translate-x-[200px] md:w-[calc(100%-200px)] pl-8 py-10 redBorder'>
    ...
    return (
        <div className='w-[600px] h-[140px] bg-white shadow-xl flex flex-row  px-4 mb-8'>
            <div className='h-full flex items-center justify-start'>
                <img src={offer.src} alt='' className = 'w-[85px] h-[85px] rounded-full ' />
            </div>
            <div className='flex flex-col justify-center ml-3 w-[350px]'>
                <p className='text-[14px] font-bold'>Introduction to Hydroponics</p>
                <p className='text-[11px] text-gray-400 '>By Introduction to Hydroponics Introduction to Hydroponics Introduction to Hydroponics</p>
